<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HelpWindow.ascx.cs" Inherits="Intranet.Web.Sistema.HelpWindow" %>
...
<ext:Window 
    ...
    <Items>
        <ext:TabPanel ID="TabPanel1" runat="server" Border="false">
            <Items>
                <ext:Panel ID="Panel1" runat="server" Title="Info" Padding="5" BodyStyle="background-color:#fff;">
                    <Content>
                ...
                <ext:Panel ID="Panel2" runat="server" Title="Credits" Padding="5" BodyStyle="background-color:#fff;">
                    <Content>
    ...
    <BottomBar>
        <ext:Toolbar ID="Toolbar1" runat="server">
            <Items>
                ...
                <ext:ToolbarTextItem ID="ToolbarTextItem1" runat="server" Text="Copyright 2006-2010 Ext.NET, Inc<br />" />
