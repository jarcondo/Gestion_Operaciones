...
{
    public partial class RptVisorCruceMaterialDetallado : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //crParameterDiscreteValue.Value = Session["Intranet.VisorReporte.IdCruce"];
            //crParameterFieldDefinitions = rptDoc.DataDefinition.ParameterFields;
            //crParameterFieldDefinition = crParameterFieldDefinitions["IdCruce"];
            //crParameterValues = crParameterFieldDefinition.CurrentValues;
            //crParameterValues.Add(crParameterDiscreteValue);
            //crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
