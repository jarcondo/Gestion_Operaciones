...
{
    public partial class rptLimpBuzonRetSolidos : BasePage
    {
        ...
        public void ObtenerDatosGrilla()
        {
            ...
            List<LimpBuzonRetSolidosDTO> olEjec = new DetalleOtrosBL().LimpBuzonRetSolidos(obra, fdesde, fhasta);
        ...
        private void CargarGrilla()
        {
            ...
            string fdesde = this.txtFDesde.Text;
            string fhasta = this.txtFHasta.Text;
            List<LimpBuzonRetSolidosDTO> oBLCMB = new DetalleOtrosBL().LimpBuzonRetSolidos(obra, fdesde, fhasta);
        ...
        protected void ToExcel(object sender, EventArgs e)
        {
            ...
            this.Response.AddHeader("Content-Disposition", "attachment; filename=LimpBuzonRetSolidos.xls");
