...
{
    public partial class rptOrdLimpColectCambioTapaBuz : BasePage
    {
        ...
        public void ObtenerDatosGrilla()
        {
            ...
            List<LimpiezaColectoresMaqBaldesDTO> olEjec = new DetalleLimpiezaBL().OrdLimpColectCambioTapaBuz(obra, fdesde, fhasta);
        ...
        private void CargarGrilla()
        {
            ...
            string fdesde = this.txtFDesde.Text;
            string fhasta = this.txtFHasta.Text;
            List<LimpiezaColectoresMaqBaldesDTO> oBLCMB = new DetalleLimpiezaBL().OrdLimpColectCambioTapaBuz(obra, fdesde, fhasta);
        ...
        protected void ToExcel(object sender, EventArgs e)
        {
            ...
            this.Response.AddHeader("Content-Disposition", "attachment; filename=OrdLimpColectCambioTapaBuz.xls");
