...
{
    public partial class rptDMTU : BasePage
    {
        ...
        protected void ObtenerDatosGrilla(object sender, EventArgs e)
        {
            ...
            List<DMTUDTO> olEjec = new EjecucionOTBL().GetEjecucionOTDMTU(obra, fdesde, fhasta);
        ...
        protected void ImprimirReporte(object sender, DirectEventArgs e)
        {
            ...
            Session["Intranet.VisorReporte.Ruta"] = "~/Sistema/Modulos/ProduccionServicios/Reportes/DMTU/rptDMTUs.rpt";
